...
Sometimes it may be possible to *transform* either the explanatory or response variable such that the relationship between the transformed variables is fit well by a line.
