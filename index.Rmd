...
# Welcome Modern Statistical Methods for Psychology {.unnumbered}
```
...
Introduction to Modern Statistics is a textbook from the [OpenIntro](https://www.openintro.org/) project.
...
The original *Introduction to Modern Statistics* textbook and its supplements, including slides, labs, and interactive tutorials, may be downloaded for free at\
