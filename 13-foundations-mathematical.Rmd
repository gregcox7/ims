...
ggplot(opportunity_cost_sim_dist, aes(x = stat)) +
  ...
  labs(
    x = "When the null hypothesis is true,\ndifference in randomized proportions of students who don't buy the video",
    y = NULL
  ) +
...
inference_method_summary_table %>%
  ...
  kbl(linesep = "\\addlinespace", booktabs = TRUE, caption = "Summary of mathematical models as an inferential statistical method.", 
