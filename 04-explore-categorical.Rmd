...
# Describing categorical data {#explore-categorical}

::: {.chapterintro data-latex=""}
This chapter focuses on describing **categorical** data using summary statistics and visualizations.
...
<!-- ```{r loan-homeownership-type-mosaic-plot, fig.cap = "The mosaic plots: one for homeownership alone and the other displaying the relationship between homeownership and application type.", fig.asp = 0.5} -->
...
```{r loan-homeownership-pie-chart, fig.cap = "A pie chart and bar plot of homeownership.", fig.width = 8}
p_pie <- loans %>% 
...
```{r loan-grade-pie-chart, fig.cap = "A pie chart and bar plot of loan grades.", fig.width = 8}
p_pie <- loans %>% 
  count(grade) %>% 
  mutate(text_y = cumsum(n) - n/2) %>% 
